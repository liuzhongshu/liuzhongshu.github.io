...
android的camera2 api比较camera功能更多一些，但是很难用，推荐使用[Fotoapparat](https://github.com/RedApparat/Fotoapparat)代替，Fotoapparat也推荐了一个[FaceDetector](https://github.com/RedApparat/FaceDetector)搭配做人脸识别。
